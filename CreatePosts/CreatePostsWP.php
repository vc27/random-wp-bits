<?php
/**
 * File Name CreatePostsWP.php
 * @package WordPress
 * @subpackage CreatePostsWP
...
if ( class_exists( 'CreatePostsWP' ) ) return;
...
class CreatePostsWP {
	...
	function add_post_meta() {
		...
		if ( $this->has_post_meta() AND $this->has_current_post_id() ) {
			...
			if ( ! class_exists( 'CreatePostsMetaWP' ) ) {
				require_once( 'CreatePostsMetaWP.php' );
			}

			if ( class_exists( 'CreatePostsMetaWP' ) ) {
				$this->_post_meta = new CreatePostsMetaWP();
	...
	function add_post_terms() {
		...
		if ( $this->has_post_terms() AND $this->has_current_post_id() ) {
			...
			if ( ! class_exists( 'CreatePostsTermsWP' ) ) {
				require_once( 'CreatePostsTermsWP.php' );
			}

			if ( class_exists( 'CreatePostsTermsWP' ) ) {
				$this->_post_terms = new CreatePostsTermsWP();
